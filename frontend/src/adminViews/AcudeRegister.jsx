...
const AcudeRegister = () => {
  const [formData, setFormData] = useState({
    ...
    link: '',
    image: '',
    schedule: []  // Aquí se almacenarán los horarios
  });
  ...
  // Añade un horario al arreglo de horarios
  const addSchedule = () => {
    if (tempSchedule) {
      setFormData({
        ...formData,
        schedule: [...formData.schedule, tempSchedule]
      });
      setTempSchedule(''); // Limpia el input temporal
    }
  };
